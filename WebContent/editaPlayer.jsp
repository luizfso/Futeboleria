  ...
  <body>
        ...
        <div class="container-fluid">
          ...
          <div class="nav-collapse collapse">
            <p class="navbar-text pull-right">
              Logged in as <a href="#" class="navbar-link">${p.username}</a>
            </p>
            <ul class="nav">
    ...
    <div class="container-fluid">
      <div class="row-fluid">
        ...
        <input type="text" name="txtNome" class="input-block-level"  value="${player.nome}" placeholder="Nome">
        <input type="text" name="txtEmail" class="input-block-level"  value="${player.email}" placeholder="Email address">
        <input type="text" name="txtEndereco" class="input-block-level" value="${player.endereco}" placeholder="Endereço">
        <input type="text" name="txtBairro" class="input-block-level"  value="${player.bairro}" placeholder="Bairro">
        <input type="text" name="txtCidade" class="input-block-level"  value="${player.cidade}" placeholder="Cidade">
        <input type="text" name="txtTelefone" class="input-block-level"  value="${player.telefone}" placeholder="Telefone">
        <input type="text" name="txtCpf" class="input-block-level" value="${player.cpf}" placeholder="CPF">
